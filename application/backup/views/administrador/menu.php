<section class="container-fluid">
	<div class="row">
		<div id="menu-lateral" class="col-md-2 hidden-xs hidden-menu-lateral">
			<ul class="nav nav-pills nav-stacked affix" role="tablist">
	        	...
	        	<li role="presentation" <?php echo $opcao == "aparencia" ? 'class="active"' : "" ?>><a href="#">Aparência</a></li>
	        	<li role="presentation" <?php echo $opcao == "configuracao" ? 'class="active"' : "" ?>><a href="#">Configuração</a></li>
	    	</ul>
		</div>	